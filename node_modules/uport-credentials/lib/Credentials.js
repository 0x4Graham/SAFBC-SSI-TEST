...
var Credentials = function () {
  ...
  (0, _createClass3.default)(Credentials, [{
    ...
    value: function createVerificationSignatureRequest(unsignedClaim) {
      ...
      return this.signJWT({ unsignedClaim: unsignedClaim, sub: sub, riss: riss, aud: aud, callback: callbackUrl, type: Types.VER_REQ });
    }
    ...
    value: function createTxRequest(txObj) {
      var _ref4 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
          ...
          _ref4$exp = _ref4.exp,
          exp = _ref4$exp === undefined ? 600 : _ref4$exp,
    ...
    value: function () {
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                credentials = (0, _extends3.default)({}, doc.uportProfile || {}, payload.own || {}, payload.capabilities && payload.capabilities.length === 1 ? { pushToken: payload.capabilities[0] } : {}, { did: payload.iss, boxPub: payload.boxPub });
      ...
      function processDisclosurePayload(_x8) {
    ...
    value: function () {
      var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(token) {
        var callbackUrl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

        var _ref9, payload, doc, challenge;
      ...
      function authenticateDisclosureResponse(_x10) {
    ...
    value: function () {
      var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(token) {
        var _ref11, payload, doc;
